...
WEBTELEMETRY_PROFILE=test01_fronthaul
WEBTELEMETRY_EBS=30GB_opt

HBASE_MASTER_TYPE=c3.2xlarge
HBASE_MASTER_PROFILE=test01_backhaul
HBASE_MASTER_EBS=60GB_hbase_master

HBASE_WORKER_TYPE=c3.2xlarge
HBASE_WORKER_PROFILE=test01_backhaul
HBASE_WORKER_EBS=100GB_hbase_worker

SEP_TYPE=m3.medium
SEP_PROFILE=test01_fronthaul

OADR2_TYPE=m3.medium
OADR2_PROFILE=test01_fronthaul

SFTP_TYPE=m3.medium
SFTP_PROFILE=test01_fronthaul
SFTP_EBS=30GB_opt


Usage="launch-test.sh [grafana | grafana | hbase-master | hbase-worker | fluxe | telegraf | sftp ] <env name> \n
