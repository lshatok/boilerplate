...
for prog in $scp_path $sftp_server_path $rssh_path $chroot_helper_path \
            /lib/x86_64-linux-gnu/libnss_compat* /lib/x86_64-linux-gnu/libnss_files*; do
...
tar -cf - /lib/x86_64-linux-gnu/libnss_compat* /lib/x86_64-linux-gnu/libnss_files* | tar -C "$jail_dir" -xvf - |sed 's/^/\t/'
...
echo -e "you may need to copy some of the /lib/x86_64-linux-gnu/libnss_* files into the jail.\n"
