...
This script also assumes that there is an ec2.ini file which exists alongside it. To specify a
different path to ec2.ini file, just define the EC2_INI_PATH environment variable:
